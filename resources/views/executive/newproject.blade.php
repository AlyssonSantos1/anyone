...
<body>
    <form action="{{  route('')  }}" method="POST">
        ...
        <input type="text" placeholder="managername" name="managername_team" >
        <br><br>
        <label for="">Numberofmembers</label>
        <input type="text" placeholder="numberofmembers" name="numberofmembers_team">
        <br><br>
        <label for="">Goals</label>
        <input type="text" placeholder="goals" name="goals_team">
        <br><br>
        <label for="">Description</label>
        <input type="text" placeholder="description" name="description_team">
        <br><br>
